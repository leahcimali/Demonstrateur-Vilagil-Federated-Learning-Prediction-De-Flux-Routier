...
def plot_box(experiment_path, sensor_selected):
    ...
    # FEDERATED
    fed_fig = plot_box_configurable("Federated Prediction", ae_fed, max_y_value, color_fed)

    # LOCAL
    local_fig = plot_box_configurable("Local Prediction", ae_local, max_y_value, color_local)

    with st.spinner('Plotting...'):
        st.subheader(f"Comparison between Federation and Local version on sensor {params.nodes_to_filter[int(sensor_selected)]} (Absolute Error)")
